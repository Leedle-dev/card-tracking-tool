...
CREATE INDEX IF NOT EXISTS idx_card_inventory_import_id ON card_inventory(import_id);
CREATE INDEX IF NOT EXISTS idx_card_inventory_grading_company_id ON card_inventory(grading_company_id);
